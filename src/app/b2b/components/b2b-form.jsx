    ...
    <form onSubmit={handleSubmit}>
        <div className="row">
            <div className="col-12">
                <h2 className="modal-title" id="exampleModalLabel">B2B Enquiry</h2>
            </div>
        </div>
        ...
        <div className="row form-row">	
            ...
            <div className="col-12 message">
                <div className='ps-3'>
                {isSuccess === true && <h3 className="text-success">Your B2B Enquiry has been submitted!</h3>}
                {isError === true && <h3 className="text-danger">Error while submitting your B2B Enquiry</h3>}
                </div>
            </div>
        </div>
    </form>
