...
export const createNewPosts = async ({data, image, redIconOne, redIconTwo, redIconThree, redIconFour}) => {
    /*debugger;*/
    if(!data?.name) {
    ...
    if(!redIconOne) {
        throw new Error("redIconOne is not selected");
    }
    if(!data?.slogan1) {
...
/*s-update*/
export const updatePosts = async ({data, image, redIconOne, redIconTwo, redIconThree, redIconFour}) => {
    if(!data?.name) {
        throw new Error("Name is undefined");
    }
    if(!data?.slug) {
