"use client";
import { getCategory } from "@/app/lib/firebase/international-carousel/read";
import { createNewCategory, deleteCategory, updateCategory } from "@/app/lib/firebase/international-carousel/write";
...
export default function CategoryFormContextProvider({children}){
    ...
    const handleDelete = async (id) => {
        ...
        try{         
            ...
            setIsDone(true);
            router.push('/backend/admin/international-carousel');
        } catch (error) {
            setError(error?.message);
        }
        setIsloading(false);
