"use client";
import { getCategory } from "@/app/lib/firebase/event/read";
import { createNewCategory, deleteCategory, updateCategory } from "@/app/lib/firebase/event/write";
...
export default function CategoryFormContextProvider({children}){
    ...
    const handleDelete = async (id) => {
        ...
        try{         
            ...
            setIsDone(true);
            router.push('/backend/admin/events');
        } catch (error) {
            setError(error?.message);
        }
        setIsloading(false);
