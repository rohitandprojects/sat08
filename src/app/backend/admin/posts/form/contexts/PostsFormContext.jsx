"use client";
import { getPosts } from "@/app/lib/firebase/post/read";
import { createNewPosts, deletePosts, updatePosts } from "@/app/lib/firebase/post/write";
...
export default function PostsFormContextProvider({children}){
    ...
    const handleDelete = async (id) => {
        ...
        try{         
            ...
            setIsDone(true);
            router.push('/backend/admin/posts');
        } catch (error) {
            setError(error?.message);
        }
        setIsloading(false);
