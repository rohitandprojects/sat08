    ...
    return <main className="w-100">        
        <div className="d-flex w-100 justify-content-between add-categories align-items-center mb-3">
            <h3 className="category-form-title align-items-center">
                ...
                <div>Media &rarr; Outdoors</div>
            </h3>
            <Link href={'/backend/admin/outdoors/'}>
        ...
        <div className="row">
            ...
            <div className="col-lg-6 col-md-6 col-sm-6">
                <ExportedImage src="/outdoors-carousel.webp" className="w-100 h-auto" width={772} height={442} alt="TVC"/>
            </div>
        </div>
        </form>
    </main>
