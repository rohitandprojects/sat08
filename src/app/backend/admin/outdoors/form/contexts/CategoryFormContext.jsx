"use client";
import { getCategory } from "@/app/lib/firebase/outdoors/read";
import { createNewCategory, deleteCategory, updateCategory } from "@/app/lib/firebase/outdoors/write";
...
export default function CategoryFormContextProvider({children}){
    ...
    const handleDelete = async (id) => {
        ...
        try{         
            ...
            setIsDone(true);
            router.push('/backend/admin/outdoors');
        } catch (error) {
            setError(error?.message);
        }
        setIsloading(false);
