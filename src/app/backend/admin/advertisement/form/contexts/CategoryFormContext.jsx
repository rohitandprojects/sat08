"use client";
import { getCategory } from "@/app/lib/firebase/advertisement/read";
import { createNewCategory, deleteCategory, updateCategory } from "@/app/lib/firebase/advertisement/write";
...
export default function CategoryFormContextProvider({children}){
    ...
    const handleDelete = async (id) => {
        ...
        try{         
            ...
            setIsDone(true);
            router.push('/backend/admin/advertisement');
        } catch (error) {
            setError(error?.message);
        }
        setIsloading(false);
