...
export default function Page(){
    ...
    return <main className="w-100">        
        <div className="d-flex w-100 justify-content-between add-categories align-items-center mb-3">
            ...
            <Link href={'/backend/admin/advertisement/'}>
        ...
        <div className="row">
            ...
            <div className="form-group">
                <label className="form-label"><strong>Advertisement Name</strong> <span>*</span></label>
            ...
            <div className="form-group">
                <label className="form-label"><strong>Advertisement Slug</strong> <span>*</span></label>
            ...
            <div className="form-group">
                <label className="form-label"><strong>Advertisement Image</strong></label>
