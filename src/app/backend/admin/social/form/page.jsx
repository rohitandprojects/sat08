    ...
    return <main className="w-100">        
        <div className="d-flex w-100 justify-content-between add-categories align-items-center mb-3">
            <h3 className="category-form-title align-items-center">
                ...
                <div>Media &rarr; Social Media</div>
            </h3>
            <Link href={'/backend/admin/social/'}>
        ...
        <div className="row">
            ...
            <div className="form-group">
                <label className="form-label"><strong>Post Slug</strong> <span>*</span></label>
                <input type="text" className="form-control" disabled={updateCategoryId} placeholder="Post Slug"
                onChange={(e) => {
            ...
            <div className="form-group">
                <label className="form-label"><strong>Post Image</strong></label>
                <div className="product-image-wrap">
                    ...
                    <div className="product-control">
                        <input type="file" accept="image/*" className="form-control" placeholder="Post Image"
                        onChange={(e) => {
            ...
            <div className="col-lg-6 col-md-6 col-sm-6">
                <ExportedImage src="/social-media.webp" className="w-100 h-auto" width={774} height={806} alt="social media"/>
            </div>
        </div>
        </form>
    </main>
