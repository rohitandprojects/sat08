"use client";
import { getCategory } from "@/app/lib/firebase/social/read";
import { createNewCategory, deleteCategory, updateCategory } from "@/app/lib/firebase/social/write";
...
export default function CategoryFormContextProvider({children}){
    ...
    const handleDelete = async (id) => {
        ...
        try{         
            ...
            setIsDone(true);
            router.push('/backend/admin/social');
        } catch (error) {
            setError(error?.message);
        }
        setIsloading(false);
