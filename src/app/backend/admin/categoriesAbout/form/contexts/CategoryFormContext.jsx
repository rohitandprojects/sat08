"use client";
import { getCategory } from "@/app/lib/firebase/categoryAbout/read";
import { createNewCategory, deleteCategory, updateCategory } from "@/app/lib/firebase/categoryAbout/write";
...
export default function CategoryFormContextProvider({children}){
    ...
    const handleDelete = async (id) => {
        ...
        try{         
            ...
            setIsDone(true);
            router.push('/backend/admin/categoriesAbout');
        } catch (error) {
            setError(error?.message);
        }
        setIsloading(false);
