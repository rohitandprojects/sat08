"use client";
import { getCategory } from "@/app/lib/firebase/catalogue/read";
import { createNewCategory, deleteCategory, updateCategory } from "@/app/lib/firebase/catalogue/write";
...
export default function CategoryFormContextProvider({children}){
    ...
    const handleDelete = async (id) => {
        ...
        try{         
            ...
            setIsDone(true);
            router.push('/backend/admin/catalogue');
        } catch (error) {
            setError(error?.message);
        }
        setIsloading(false);
