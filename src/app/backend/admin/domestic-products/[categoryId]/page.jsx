                ...
                return <tr data-key={item?.id} key={item?.id}>
                    ...
                    <td className="catename-slug">
                        {matchCateName?.map((cateName, key) => {
                            return <>{(cateName?.id == item?.categoryId) && <p key={cateName?.name}><span>Name:</span><strong>{cateName?.name}</strong></p>}</>
                        })}
                    ...
                    <td className="packaging">
                        ...
                        <div className="packaging-wrap">
                            <div className="packaging-row">
                                ...
                                return <div className="packaging-card" key={imgSrc+index}><div className="sku-icon"><img src={`/images/sku/${imgSrc}`} alt={title}/></div><h4>{title}</h4></div>
                                })}
                            </div>
                            <div className="packaging-row">
