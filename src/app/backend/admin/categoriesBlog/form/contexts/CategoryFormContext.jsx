"use client";
import { getCategory } from "@/app/lib/firebase/categoryBlog/read";
import { createNewCategory, deleteCategory, updateCategory } from "@/app/lib/firebase/categoryBlog/write";
...
export default function CategoryFormContextProvider({children}){
    ...
    const handleDelete = async (id) => {
        ...
        try{         
            ...
            setIsDone(true);
            router.push('/backend/admin/categoriesBlog');
        } catch (error) {
            setError(error?.message);
        }
        setIsloading(false);
