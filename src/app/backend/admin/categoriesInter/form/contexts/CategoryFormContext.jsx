"use client";
import { getCategory } from "@/app/lib/firebase/categoryInter/read";
import { createNewCategory, deleteCategory, updateCategory } from "@/app/lib/firebase/categoryInter/write";
...
export default function CategoryFormContextProvider({children}){
    ...
    const handleDelete = async (id) => {
        ...
        try{         
            ...
            setIsDone(true);
            router.push('/backend/admin/categoriesInter');
        } catch (error) {
            setError(error?.message);
        }
        setIsloading(false);
