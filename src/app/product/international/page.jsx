...
export default function Page(){
    ...
    if(isLoading){
        return <div className='vw-100 vh-100 d-flex align-items-center justify-content-center loading-text'><h3>...loading...</h3></div>
    }
    if (data?.length){
        return redirect(`/product/international/${data[0]?.id}`)
    }
}